                    ...
                    actions={[
                        {
                            ...
                            onClick: (event) => {if (this.props.history) {
                                this.props.history.push('/desarrollo_humano/agregar_institucion');
                            }}
                        },
                        {
                            icon: 'delete',
                        ...
                        {
                            icon: 'edit',
                            tooltip: 'EditarInstitución',
                            onClick: (event, rowData) => {if (rowData.length === 1) {
                                this.props.history.push(`/desarrollo_humano/agregar_institucion/${rowData[0].id}`);
                            } else {
